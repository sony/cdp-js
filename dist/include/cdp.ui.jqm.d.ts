...
declare namespace CDP.UI {
    ...
    class Theme {
        ...
        private static s_transitionMap;
        /**
         ...
         */
        static setTransitionMap(map: TransitionMap): void;
        /**
         * transition を取得
         ...
         * @return {String[]} "slide"
         */
        static queryTransition(original: string): string;
    }
}
declare namespace CDP.UI {
    /**
    ...
    class ExtensionManager {
         ...
         * DOM 拡張を適用
         *
         * @param {jQuery} $page     [in] 拡張対象の DOM
         * @param {Object} [options] [in] オプション
         */
        static applyDomExtension($page: JQuery, options?: DomExtensionOptions): void;
    }
}
declare namespace CDP.UI {
    /**
...
declare namespace CDP.UI {
     ...
     */
    type DialogBackKeyHandler = (event?: BaseJQueryEventObject) => void;
    /**
    ...
    class Dialog {
         ...
         */
        protected onBeforeShow(): JQueryPromise<void>;
        /**
         * Dialog の既定オプションを更新
...
declare namespace CDP.UI {
     ...
     */
    interface BaseHeaderViewOptions<TModel extends Backbone.Model> extends Backbone.ViewOptions<TModel> {
        baseTemplate?: JST;
     ...
     * @brief 共通ヘッダを操作するクラス
     */
    class BaseHeaderView<TModel extends Backbone.Model> extends Backbone.View<TModel> {
        private _owner;
        private _options;
        private static s_$baseHeader;
...
declare namespace CDP.UI {
     ...
     */
    interface BasePageOptions<TModel extends Backbone.Model> extends Framework.PageConstructOptions, BaseHeaderViewOptions<TModel> {
     ...
     */
    class BasePage<TModel extends Backbone.Model> extends Framework.Page {
        private _options;
        private _baseHeader;
        /**
         * constructor
...
declare namespace CDP.UI {
     ...
     */
    interface PageViewConstructOptions<TModel extends Backbone.Model> extends BasePageOptions<TModel> {
