...
declare module "cdp/framework/jqm" {
    ...
    export const Patch: typeof CDP.Framework.Patch;
    ...
    export const setupEventHandlers: typeof CDP.Framework.setupEventHandlers;
    export const setActivePage: typeof CDP.Framework.setActivePage;
...
declare module "cdp/tools/tools" {
    ...
    export const doWork: typeof CDP.Tools.doWork;
