...
declare module "cdp/tools/tools" {
    ...
    export module Blob {
        ...
        const dataUrlToBlob: typeof CDP.Tools.Blob.dataUrlToBlob;
        ...
        const readBlobAsArrayBuffer: typeof CDP.Tools.Blob.readBlobAsArrayBuffer;
        const readBlobAsUint8Array: typeof CDP.Tools.Blob.readBlobAsUint8Array;
        const readBlobAsText: typeof CDP.Tools.Blob.readBlobAsText;
        const readBlobAsDataURL: typeof CDP.Tools.Blob.readBlobAsDataURL;
        const URL: any;
    }
