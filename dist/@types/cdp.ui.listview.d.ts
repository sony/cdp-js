...
declare namespace CDP.UI {
    ...
    module _ListViewUtils {
         ...
         * @return {Number} value
         */
        const getCssMatrixValue: (element: JQuery<HTMLElement>, type: string) => number;
        /**
         ...
         */
        const setTransformsTransitions: (element: JQuery<HTMLElement>, prop: string, msec: number, timingFunction: string) => void;
        /**
         * transition 設定の削除
         *
         * @private
         * @param {Object} element
         */
        const clearTransitions: (element: JQuery<HTMLElement>) => void;
        /**
         * Math.abs よりも高速な abs
         */
         ...
         * Math.max よりも高速な max
         */
        const max: (lhs: number, rhs: number) => number;
    }
}
declare namespace CDP.UI {
    /**
...
declare namespace CDP.UI {
     ...
     */
    interface ListItemViewOptions<TModel extends Backbone.Model = Backbone.Model> extends Backbone.ViewOptions<TModel> {
        owner: BaseListView;
        $el?: JQuery;
     ...
     */
    class ListItemView<TModel extends Backbone.Model = Backbone.Model> extends Backbone.View<TModel> implements IListItemView, IComposableView {
        private _owner;
...
declare namespace CDP.UI {
    ...
    class ScrollManager implements IListViewFramework, IScrollable, IBackupRestore {
        ...
        removeItem(index: number, size?: number, delay?: number): void;
        removeItem(index: number[], delay?: number): void;
        _removeLine(index: number, size?: number, delay?: number): void;
        _removeLines(indexes: number[], delay?: number): void;
        private setupScrollMapTransition($map, delay);
        getItemInfo(target: number): any;
        getItemInfo(target: JQuery.Event): any;
        refresh(): void;
        update(): void;
...
declare namespace CDP.UI {
     ...
     */
    interface ListViewConstructOptions<TModel extends Backbone.Model = Backbone.Model> extends ListViewOptions, Backbone.ViewOptions<TModel> {
        $el?: JQuery;
     ...
     */
    class ListView<TModel extends Backbone.Model = Backbone.Model> extends Backbone.View<TModel> implements IListView, IComposableView {
        private _scrollMgr;
        /**
         * constructor
         *
...
declare namespace CDP.UI {
     ...
     */
    interface GroupListItemViewOptions<TModel extends Backbone.Model = Backbone.Model> extends ListItemViewOptions<TModel> {
     ...
     */
    class GroupListItemView<TModel extends Backbone.Model = Backbone.Model> extends ListItemView<TModel> {
...
declare namespace CDP.UI {
     ...
     */
    class ExpandableListView<TModel extends Backbone.Model = Backbone.Model> extends ListView<TModel> implements IExpandableListView {
        private _statusMgr;
