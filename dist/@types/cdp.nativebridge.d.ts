 ...
 *
 * Manual Hot Fix: 2017/06/19
 * Date: 2016-03-23T21:32:57
 */
...
declare module CDP {
    module NativeBridge {
        ...
        class Utils {
             ...
             */
            static makePromise(df: JQueryDeferred<IResult>): IPromise<any>;
            /**
             * \~english
...
declare module CDP {
    module NativeBridge {
        ...
        class Gate {
             ...
             * @return {IPromiseBase} jQuery.Promise object.
             *
             * \~japanese
             * すべてのタスクのキャンセル
             *
             * @param options {ExecOptions?} [in] 実行オプションを指定
             * @return {IPromiseBase} jQuery.Promise オブジェクト
             */
