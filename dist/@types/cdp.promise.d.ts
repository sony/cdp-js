...
declare namespace CDP {
    ...
    interface IPromiseBase<T> extends Promise<T> {
        then: <TResult1, TResult2 = never>(onfulfilled?: ((value?: TResult1, ...values: any[]) => TResult1 | PromiseLike<TResult1> | void) | undefined | null, onrejected?: ((reason?: any, ...values: any[]) => TResult2 | PromiseLike<TResult2> | void) | undefined | null) => IPromiseBase<TResult1 | TResult2>;
        state: () => string;
    ...
    interface IPromise<T> extends IPromiseBase<T> {
        ...
        then: <TResult1, TResult2 = never>(onfulfilled?: ((value?: TResult1, ...values: any[]) => TResult1 | PromiseLike<TResult1> | void) | undefined | null, onrejected?: ((reason?: any, ...values: any[]) => TResult2 | PromiseLike<TResult2> | void) | undefined | null) => IPromise<TResult1 | TResult2>;
        state: () => string;
     ...
     * @return {JQueryPromise<T>} Promise オブジェクト
     */
    function race<T>(...deferreds: IPromise<T>[]): JQueryPromise<T>;
    function race<T>(...deferreds: JQueryGenericPromise<T>[]): JQueryPromise<T>;
    function race<T>(...deferreds: T[]): JQueryPromise<T>;
    /**
