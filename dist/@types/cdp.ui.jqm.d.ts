...
declare namespace CDP.UI {
     ...
     */
    interface TabViewConstructionOptions<TModel extends Model = Model> extends ListViewConstructOptions<TModel> {
        host: TabHostView;
    ...
    interface TabViewContext<TModel extends Model = Model> {
        ...
        options?: TabViewConstructionOptions<TModel>;
    }
    /**
    ...
    interface TabHostViewConstructOptions<TModel extends Model = Model> extends PageContainerViewOptions<TModel>, FlipsnapOptions {
        ...
        scrollHandler?: (event: JQuery.Event) => void;
        scrollStopHandler?: (event: JQuery.Event) => void;
        tabMoveHandler?: (delta: number) => void;
        tabStopHandler?: (newIndex: number, moved: boolean) => void;
    }
    /**
     * @class TabHostView
