...
declare namespace CDP.UI {
     ...
     */
    namespace PAGEVIEW_EVENTS {
        const ORIENTATION_CHANGED = "pageview:orientation-changed";
        const INITIALZSE = "pageview:initialize";
        const PAGE_BEFORE_CREATE = "pageview:before-create";
        const PAGE_INIT = "pageview:page-init";
        const PAGE_BEFORE_SHOW = "pageview:before-show";
        const PAGE_SHOW = "pageview:show";
        const PAGE_BEFORE_HIDE = "pageview:before-hide";
        const PAGE_HIDE = "pageview:hide";
        const PAGE_REMOVE = "pageview:remove";
    }
    /**
