...
declare namespace CDP.Tools {
    ...
    class Binary {
         ...
         * @returns Blob data
         */
        static uint8ArrayToBlob(array: Uint8Array, mimeType?: string): Blob;
        /**
         ...
         * @return {Blob} Blob data
         */
        static textToBlob(text: string, mimeType?: string): Blob;
        /**
         ...
         * @return {CDP.IPromise<string>} promise object
         */
        static readBlobAsBase64(blob: Blob): IPromise<string>;
        /**
         ...
         * @return {CDP.IPromise<Uint8Array>} promise object
         */
        static readBlobAsText(blob: Blob, encoding?: string): IPromise<string>;
        /**
         ...
         */
        static dataURLToUint8Array(dataURL: string): Uint8Array;
        /**
         ...
         */
        static textToArrayBuffer(text: string): ArrayBuffer;
        /**
         ...
         */
        static arrayBufferToDataURL(buffer: ArrayBuffer, mimeType?: string): string;
        /**
         ...
         */
        static uint8ArrayToDataURL(array: Uint8Array, mimeType?: string): string;
        /**
         ...
         */
        static dataURLToText(dataURL: string): string;
        /**
         ...
         */
        static textToDataURL(text: string, mimeType?: string): string;
        /**
         ...
         */
        private static execDataURLRegExp(dataURL);
        private static uint8ArrayToByteString(array);
        private static base64ToByteString(base64);
        private static textToByteString(text);
        private static byteStringToUint8Array(bytes);
        private static byteStringToBase64(bytes);
        private static byteStringToText(bytes);
    }
}
/**
...
declare namespace CDP.Tools {
     ...
     */
    class Template {
        private static _mapElement;
        private static _mapSource;
        /**
