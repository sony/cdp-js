...
declare module "cdp/framework" {
    import * as _errors from "cdp/core/core";
    export * from "cdp/core/promise";
    ...
    export const RESULT_CODE: typeof CDP.RESULT_CODE;
    export const DECLARE_ERROR_CODE: typeof CDP.DECLARE_ERROR_CODE;
    export const ASSIGN_RESULT_CODE: typeof CDP.ASSIGN_RESULT_CODE;
    export const MODULE_RESULT_CODE_RANGE = 1000;
    export type RESULT_CODE_BASE = _errors.RESULT_CODE_BASE;
    export const RESULT_CODE_BASE: typeof CDP.RESULT_CODE_BASE;
    export const ASSIGN_RESULT_CODE_BASE: typeof CDP.ASSIGN_RESULT_CODE_BASE;
}
