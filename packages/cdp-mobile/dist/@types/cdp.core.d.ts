...
declare namespace CDP {
     ...
     * @returns エラーオブジェクト
     */
    function makeErrorInfo(resultCode: RESULT_CODE, tag?: string, message?: string, cause?: Error): ErrorInfo;
    /**
     ...
     */
    enum RESULT_CODE_BASE {
        RESULT_CODE_BASE_DECLARATION = 0,
        CDP,
    }
